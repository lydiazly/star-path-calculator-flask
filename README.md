...
This repository contains the source code of our [Star Path Viewer](https://starpathviewer.cc/) website, along with CLI scripts.
...
> See the [Documentation](https://docs.starpathviewer.cc/) of our web app for more details.
