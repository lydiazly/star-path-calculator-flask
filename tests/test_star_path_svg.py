...
if Version(numpy.__version__) < Version('2.0.0'):
    ...
    print(
        "Test cases: python 3.10, numpy 2.2.3, matplotlib 3.5.2, skyfield 1.49"
    )
else:
    reference_svg_filename = 'cases/diagram_matplotlib3.10.0.svg'
    print(
        "Test cases: python 3.10, numpy 2.2.3, matplotlib 3.10.0, skyfield 1.49"
    )
...
def normalize_svg_content(svg_content: str) -> str:
    ...
    svg_content = re.sub(
        r'xlink:href="#[a-z0-9]+"', 'xlink:href="#HREF"', svg_content
    )
    svg_content = re.sub(
...
with open(
    Path(__file__).parent.parent / reference_svg_filename, encoding='utf-8'
) as f:
...
def test_get_svg(normalized_reference):
    ...
    normalized_generated = normalize_svg_content(
